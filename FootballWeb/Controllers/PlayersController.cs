...
namespace FootballWeb.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Age,Nationality,Role,Description,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Age,Nationality,Role,Description,TeamId")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
